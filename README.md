...
- **API.GetEstadoLinhaTodos**: GET `/estadolinha/todos`
- **API.GetEstadoLinhaByLinha**: GET `/estadolinha/{linha}`
- **API.GetInfoDestinosTodos**: GET `/infodestinos/todos`
- **API.GetInfoEstacaoTodos**: GET `/infoestacao/todos`
- **API.GetInfoEstacaoByEstacao**: GET `/infoestacao/{estacao}`
- **API.GetInfoIntervalosByLinhaByDia**: GET `/infointervalos/{linha}/{dia}`
- **API.GetInfoIntervalosByLinhaByDiaByHora**: GET `/infointervalos/{linha}/{dia}/{hora}`
- **API.GetTempoEsperaEstacaoTodos**: GET `/tempoespera/estacao/todos`
- **API.GetTempoEsperaEstacaoByEstacao**: GET `/tempoespera/estacao/{estacao}`
- **API.GetTempoEsperaLinhaByLinha**: GET `/tempoespera/linha/{linha}`
