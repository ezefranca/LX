...
extension API {
    ...
    /** Permite obter o estado de circulação de determinada linha do Metro */
    public enum GetEstadoLinhaByLinha {

        public static let service = APIService<Response>(id: "getEstadoLinhaByLinha", tag: "", method: "GET", path: "/estadoLinha/{linha}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetEstadoLinhaByLinha.service)
            }
